...
const PostStatus = () => {
      ...
      prev.map((ref) =>
        ref.id === id
          ? {
              ...ref,
              status: newStatus,
              recruiterName: user?.name || "Pending",
            }
          : ref
      )
    );
  ...
  const handleSubmit = () => {
    ...
    toast.success("✅ Candidate statuses updated successfully!", {
      position: "top-center",
      autoClose: 2000,
      theme: "colored",
    });
      ...
      <div className="mt-24 w-full max-w-3xl px-4">
        {refers.length === 0 ? (
          <p className="text-center text-xl mt-10">
            No candidates referred for your jobs yet.
          </p>
        ) : (
          refers.map((refer) => (
            <div
            ...
            >
              ...
              <p className="text-gray-300">
                <strong>Employee:</strong> {refer.referredBy}
              </p>
              <p className="text-gray-300">
                <strong>Recruiter:</strong> {refer.recruiterName || "Pending"}
              </p>
              <p className="text-gray-300">
